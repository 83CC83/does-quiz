        ...
        {step === "intro" && (
          <div style={{ animation: "fadeUp 0.6s ease-out", paddingTop: 56, position: "relative" }}>
            ...
            <div style={{ position: "relative", zIndex: 1, padding: "0 16px 28px" }}>
              ...
              <div className="sketch-box" style={{ padding: "20px 22px", marginBottom: 24, background: "rgba(255,250,252,0.9)" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 32 }}>
                {[["D","深度處理","Depth of Processing"],["O","過度刺激","Overstimulation"],["E","情緒同理","Emotional Reactivity"],["S","感官敏感","Sensory Sensitivity"]].map(([k,zh,en]) => (
                  <div key={k} className="sketch-box" style={{ padding: "14px 16px", background: "rgba(255,250,252,0.9)" }}>
                  ...
                  {isFirst ? (
                    ...
                    <div className="sketch-box" style={{ display: "flex", gap: 14, padding: 0, overflow: "hidden", marginBottom: 0 }}>
                      <img src={IMAGES[animal.key]} alt={animal.name}
                        style={{ width: 110, height: 130, objectFit: "cover", objectPosition: "center 15%", display: "block", mixBlendMode: "multiply", flexShrink: 0, borderRadius: "16px 0 0 16px" }} />
